...
Spring Boot faciliteert meerdere manieren om exceptions af te handelen. 
...
Kijk nu wat er gebeurt op:
 - `http://localhost:8081/movies/?id=4`
 - of `http://localhost:8081/movies/4`.
...
Als bovenstaande is gelukt, dan krijg je nu een nette response in de browser op adres: `http://localhost:8081/movies/?id=4`
